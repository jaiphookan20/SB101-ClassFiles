...
class Common{
	...
	/* If synchronized keyword is not part of method signature, then lock is not achieved, and output becomes
	 * t1->t2 -> Welcome Welcome Ram Shyam
       t2->t1  -> Welcome Welcome Shyam Ram
       
       If synchronized is part of keyword like below, output becomes: 
       after synchronization (opt2)
        t1->t2 -> Welcome Ram Welcome Shyam
        t2->t1  -> Welcome Shyam Welcome Ram
	 */
